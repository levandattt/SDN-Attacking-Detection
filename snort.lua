...
rate_filter =
{
    -- Limit ICMP flood alerts: 1 alert every 5 seconds per source
    { gid = 1, sid = 1000001, track = 'by_src', count = 1, seconds = 10,
      new_action = 'alert', timeout = 5 },

    -- Limit TCP SYN flood alerts: 1 alert every 5 seconds per source
    { gid = 1, sid = 1000002, track = 'by_src', count = 1, seconds = 10,
      new_action = 'alert', timeout = 5 },
}

-- threshold = '/usr/local/etc/snort/threshold.conf'
